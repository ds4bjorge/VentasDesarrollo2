...
- recuerda que las variables del dataframe df que tienes que usar sisempre en el codigo que generes son: 
df: ['fecha', 'producto_id', 'nombre', 'categoria', 'subcategoria',
       'precio_base', 'es_estrella', 'unidades_vendidas', 'precio_venta',
       'ingresos', 'dia_semana', 'año', 'mes', 'dia_mes', 'nombre_dia_semana',
       'es_fin_semana', 'es_festivo', 'es_black_Friday', 'es_cyber_Monday',
       'semana_año', 'trimestre', 'es_laborable', 'lag_1', 'lag_2', 'lag_3',
